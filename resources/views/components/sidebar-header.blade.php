<a class=" text-gray-500  dark:text-gray-200" href="/">
 ...
 <p class=" text-xs font-medium dark:bg-gray-800 bg-gray-900 mx-6 py-1 px-2 rounded text-gray-400">Administrator</p>
 @endif 
 ...
 <p class="text-xs font-medium dark:bg-gray-800 bg-gray-900 mx-6 py-1 px-2 rounded text-gray-400">{{auth()->user()->name}}</p>
 @endif 
