...
<div class="flex w-full">
  <a href="/" class=" mb-2 f item-center  mr-2 shadow-xs dark:bg-gray-700 text-blue-400 font-bold  p-3 rounded">
  ...
  <div class="flex w-full items-center justify-between p-3 mb-2 text-sm font-semibold text-gray-500 dark:text-gray-400 shadow-xs dark:bg-gray-700 bg-gray-50 rounded-lg  ">
