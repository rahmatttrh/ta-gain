<aside class="z-20 hidden w-64 overflow-y-auto bg-gray-700 dark:bg-gray-700 md:block flex-shrink-0">
  <div class="py-4 text-gray-500 dark:text-gray-400">
    ...
    <div class="px-6 my-2">
      <a href="{{route('job.create')}}">
        <button class="flex items-center justify-between w-full px-4 py-2 text-sm font-medium leading-5 text-white transition-all duration-300  hover:from-blue-300 outline hover:to-blue-500 rounded active:bg-teal-600 hover:bg-teal-800 focus:outline-none focus:shadow-outline-teal">
          Buat Order
