    ...
    {{-- @if($order->status < '7' ) <!-- -->
      ...
      <div class="flex items-center justify-between p-4 mb-2 mt-4   text-gray-50 bg-green-400 rounded  ">
        <div class="flex items-center">
          ...
          <a href="{{ route('client.jobreport.detail', $order) }}" class="ml-6 mr-2 bg-white text-xs font-medium  text-gray-500 py-1 px-4 pr-8 rounded-full leading-tight hover:bg-gray-100">
            Report
          </a>
