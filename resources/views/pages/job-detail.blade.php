    ...
    {{-- @if($order->status < '7' ) <!-- -->
      ...
      <div class="flex items-center justify-between p-4 mb-2 mt-4 text-sm font-semibold text-gray-50 bg-green-400 rounded  ">
        <div class="flex items-center">
          ...
          <span>Job Order telah selesai</span>
          <a href="{{ route('jobreport.detail', $order) }}" class="ml-6 mr-2 bg-white font-semibold  text-gray-500 py-1 px-4 pr-8 rounded-full leading-tight hover:bg-gray-100">
            Report
          </a>
          <a href="{{route('download.bast', $order)}}" class=" bg-white font-semibold  text-gray-500 py-1 px-4 pr-8 rounded-full leading-tight hover:bg-gray-100">Download BAST</a>
        </div>
      </div>
