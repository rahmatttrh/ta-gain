<x-app-layout>
 ...
 @endsection
 <div class="flex">
   <a href="{{route('finish.kordinator')}}" class=" mb-4 w-12 f item-center  mr-2 shadow-xs dark:bg-gray-700 text-blue-400 font-bold  p-3 rounded">
 ...
 <a href="{{route('download.bast.master', $order)}}"  class="mb-6 text-center py-2 mr-1 bg-green-500 text-gray-100 py-1 px-4  rounded-xl leading-tight hover:bg-green-600">
