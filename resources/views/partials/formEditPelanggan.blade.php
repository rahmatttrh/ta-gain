<x-app-layout>
 ...
 @endsection
 <div class="flex">
   <a href="{{route('client')}}" class=" mb-2 w-12 f item-center  mr-2 shadow-xs dark:bg-gray-700 text-blue-400 font-bold  p-3 rounded">
   ...
   <x-header>EDIT <span class="font-bold">CLIENT</span></x-header>
 </div>
...
<div class="w-full overflow-hidden rounded-lg shadow-xs mb-5">
  ...
  <div class="mt-4 mb-6 px-5">
   <form action="{{route('client.update', $client)}}" method="POST" class="w-full lg:flex " enctype="multipart/form-data">
     @csrf
     @method('put')
     <div class="lg:w-1/2 lg:mr-4">
       ...
       <div class="mb-4">
         ...
         <input  type="email" disabled value="{{$client->email}}" name="email" class="appearance-none block w-full bg-gray-200   text-gray-700  border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="Email ...">
