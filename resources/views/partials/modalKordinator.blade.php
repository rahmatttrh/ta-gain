          ...
          <form action="" class="w-full ">
           @csrf
             ...
             <div class="mb-4">
               ...
               <input name="noKordinator"  type="number" class="appearance-none block w-full bg-gray-200   text-gray-700  border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="No HP ...">
             ...
             <div class="mb-4">
              ...
              <div class="mb-4">
                ...
                <input name="noRek"  type="number" class="appearance-none block w-full bg-gray-200   text-gray-700  border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="No. Rek ...">
                ...
                <div class="mb-4">
                  ...
                  <input class="w-1/2" name="fotoKtp" type="file" required>
                ...
                <div class="mb-4">
                  ...
                  <input class="w-1/2" name="fotoDiri" type="file" required>
                  <img class="w-1/2 mr-2 rounded" src="">
