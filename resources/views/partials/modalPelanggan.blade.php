<div
      ...
      class="fixed inset-0 z-30 flex  bg-black overflow-y-auto bg-opacity-50 sm:items-center sm:justify-center"
     >
      <!-- Modal -->
      <div
        x-show="isModalOpen"
      ...
      >
        ...
        <div class="mt-4 mb-6">
          ...
          <!-- Modal description -->
        <form action="{{route('pelanggan')}}" method="POST" class="w-full " >
           @csrf
             <hr class="my-2">
             <div class="mb-2">
          ...
          >
            <button
              @click="closeModal"
              class="w-full px-5 py-3 text-sm font-medium leading-5 text-white text-gray-700 transition-colors duration-150 border border-gray-300 rounded dark:text-gray-400 sm:px-4 sm:py-2 sm:w-auto active:bg-transparent hover:border-gray-500 focus:border-gray-500 active:text-gray-500 focus:outline-none focus:shadow-outline-gray"
            >
              Cancel
            </button>
            <button type="submit"
