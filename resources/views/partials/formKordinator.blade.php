<x-app-layout>
  ...
  @endsection
  <div class="flex">
    <a href="{{route('kordinator')}}" class=" mb-2 w-12 f item-center  mr-2 shadow-xs dark:bg-gray-700 text-blue-700 font-bold  p-3 rounded">
    ...
    <x-header>CREATE <span class="font-bold">KORDINATOR</span></x-header>
  </div>
 ...
 <div class="w-full overflow-hidden rounded-lg shadow-xs mb-4">
  ...
  <form action="{{route('kordinator.create')}}" method="POST" class="w-full flex" enctype="multipart/form-data">
    @csrf
      ...
      <div class="mr-4 w-1/2">
        <div class="mb-4">
          ...
          <input  type="text" name="namaKordinator" class="appearance-none block w-full bg-gray-200   text-gray-700  border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="Nama ...">
        ...
        <div class="mb-4">
          ...
          <input name="noKordinator"  type="text" class="appearance-none block w-full bg-gray-200   text-gray-700  border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="No HP ...">
      ...
      <div class="w-1/2">
        ...
        {{-- <footer
          class="flex flex-col w-full block items-center  px-6 py-3 -mx-6 -mb-4 space-y-4 sm:space-y-0 sm:space-x-6 sm:flex-row bg-gray-50 dark:bg-gray-800"
        >
          
          <button
            class="w-full block px-5 py-3 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-teal-600 border border-transparent rounded sm:w-auto sm:px-4 sm:py-2 active:bg-teal-600 hover:bg-teal-700 focus:outline-none focus:shadow-outline-teal"
          >
            Simpan
          </button>
        </footer> --}}
