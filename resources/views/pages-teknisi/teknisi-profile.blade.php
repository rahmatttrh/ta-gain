<x-app-layout>
  ...
  @endsection
  <div class="flex">
    {{-- <a href="/" class=" mb-4 w-12 f item-center  mr-2 shadow-xs dark:bg-gray-700 text-blue-400 font-bold  p-3 rounded">
 ...
 <div class="w-full overflow-hidden rounded-lg shadow-xs mb-4">
  ...
  <form action="{{ route('teknisi.update.profile', $teknisi) }}" method="POST" class="w-full md:flex" enctype="multipart/form-data">
    @csrf
    @method('put')
      <div class="md:mr-4 md:w-1/2">
          ...
          <div class="mb-4">
            ...
            <input name="noTeknisi"  value="{{ old('noTeknisi') ?? $teknisi->no_hp}}" type="number" class="appearance-none block w-full bg-gray-200   text-gray-700  border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="No HP ...">
          ...
          <div class="mb-4">
            ...
            <input name="email" readonly  type="email" value="{{ old('email') ?? $teknisi->email}}" class="appearance-none block w-full bg-gray-200   text-gray-700  border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="Email ...">
          ...
          <div class="mb-4">
            ...
            <input name="area" readonly  type="text" value="{{ old('area') ?? $teknisi->area}}" class="appearance-none block w-full bg-gray-200   text-gray-700  border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="Area ...">
             <span class="text-sm text-gray-400">* Tidak bisa di ubah</span>
          </div>
        ...
        <div class="md:w-1/2">
          ...
          <div class="mb-4">
            ...
            <input name="noRek"  value="{{ old('noRek') ?? $teknisi->no_rek}}" type="number" class="appearance-none block w-full bg-gray-200   text-gray-700  border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="No. Rek ...">
