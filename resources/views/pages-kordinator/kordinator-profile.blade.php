  ...
  <div class="mt-4 mb-6 px-4">
      <div class="flex w-full mb-4 mt-2">
        <div class="w-1/2 mr-4 ">
          ...
          <img class="rounded-md" src="{{asset('storage/' .$kordinator->foto_ktp)}}" alt="">
        </div>
        <div class="w-1/2 ">
          <p class="block uppercase tracking-wide dark:text-gray-300 text-gray-700 text-xs font-bold mb-2">Foto Diri</p>
          <img class="rounded-md" src="{{asset('storage/' .$kordinator->foto_diri)}}" alt="">
        </div>
      </div>

  <form action="{{ route('kordinator.update.profile', $kordinator->id) }}" method="POST" class="w-full md:flex" enctype="multipart/form-data">
    @csrf
    @method('put')
      <div class="md:mr-4 md:w-1/2">
          ...
          <div class="mb-4">
            ...
            <input name="noKordinator"  value="{{ old('noKordinator') ?? $kordinator->no_hp}}" type="number" class="appearance-none block w-full bg-gray-200   text-gray-700  border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="No HP ...">
          ...
          <div class="mb-4">
            ...
            <input name="area" readonly type="text" value="{{ old('area') ?? $kordinator->area}}" class="appearance-none block w-full bg-gray-200   text-gray-700  border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="Area ...">
             <span class="text-sm text-gray-400">* Tidak bisa di ubah</span>
          </div>
        ...
        <div class="md:w-1/2">
          ...
          <div class="mb-4">
            ...
            <input name="noRek"  value="{{ old('noRek') ?? $kordinator->no_rek}}" type="number" class="appearance-none block w-full bg-gray-200   text-gray-700  border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="No. Rek ...">
