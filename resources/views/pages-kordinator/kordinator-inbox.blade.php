<x-app-layout>
    ...
    Inbox Job
    @endsection
    <x-header><span class="font-bold">LIST</span> INBOX</x-header>
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    ...
                    <tr class="text-gray-500 dark:text-gray-400 ">
                        ...
                        <td class="px-4 py-3 text-xs">
                            <a href="{{route('kordinator.inbox.detail', $joborder->joborder_id)}}" class="py-1 px-4 text-xs bg-teal-600  text-gray-100 py-1 px-4 pr-8 rounded-full leading-tight hover:bg-blue-400">
                                Detail</a>
                        </td>
                    </tr>
                    @endforeach
